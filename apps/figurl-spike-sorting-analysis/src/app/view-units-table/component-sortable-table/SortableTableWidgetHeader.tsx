...
const SortCaret = (ascending?: boolean) =>
  ascending ? <FontAwesomeIcon icon={faCaretUp} /> : <FontAwesomeIcon icon={faCaretDown} />;
      ...
      return (
        ...
        >
          <Grid container justifyContent="flex-start" style={{ flexFlow: 'row' }}>
            <Grid item key="icon">
              <span className={'SortCaretSpan'}>{column.isPrimarySort && SortCaret(column.isAscendingSort)}</span>
            </Grid>
            <Grid item key="text">
              <span>
