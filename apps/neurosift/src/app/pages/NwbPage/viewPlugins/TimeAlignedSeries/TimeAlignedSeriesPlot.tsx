...
const TimeAlignedSeriesPlot: FunctionComponent<TimeAlignedSeriesPlotProps> = ({width, height, alignToTimes, roiData, roiTimestamps, alignToVariable, windowRange, prefs}) => {
