import { DragAction, DragState, Vec2, dragReducer } from '../../../figurl-canvas';
import { Vec2H, pointSpanToRegion } from '../../../figurl-canvas/Geometry';
...
export const electrodeGeometryReducer = (
  ...
  if (action.type === 'INITIALIZE') {
    ...
    const { convertedElectrodes, pixelRadius, xMargin } = computeElectrodeLocations(
      width,
      height,
      electrodes,
      layoutMode,
