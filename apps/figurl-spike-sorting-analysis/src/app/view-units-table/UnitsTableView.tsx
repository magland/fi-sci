...
import { INITIALIZE_UNITS, UNIQUE_SELECT_FIRST, UNIQUE_SELECT_LAST, UNIQUE_SELECT_NEXT, UNIQUE_SELECT_PREVIOUS, idToNum, sortIds, useSelectedUnitIds } from '@fi-sci/context-unit-selection';
...
import { UnitsTableBottomToolbar, UnitsTableBottomToolbarOptions, defaultUnitsTableBottomToolbarOptions } from './ViewToolbar';
import { ColorPatchUnitIdLabel, ColorPatchUnitLabelProps, SortableTableWidget, SortableTableWidgetColumn, SortableTableWidgetRow } from './component-sortable-table';
...
const UnitsTableView: FunctionComponent<Props> = ({data, width, height}) => {
    ...
    const columns = useMemo(() => {
        ...
        return ret
    }, [data.columns, currentUnitId, data.similarityScores])
    ...
    }, [data.rows, data.columns, currentUnitId, data.similarityScores, checkboxClickHandlerGenerator, orderedUnitIds])
