        ...
        const contents = Object.assign(
            ...
            ...plots.map((p) => {
                ...
                const rendered =
                    ...
                    >
                        <IfVisible width={p.props.width as number} height={p.props.height as number}>
                            <span>
                                {
                                    p.label !== undefined && (
                                        <div className={'plotLabelStyle'} style={{maxWidth: p.props.width as number, height: labelHeight, userSelect: 'none'}}>
                                            <span style={{color: p.labelColor}}>{p.label || <span>&nbsp;</span>}</span>
                                        </div>
                                    )
                                }
                                <Component {...{...p.props, height: p.props.height as number ? (p.props.height as number) - labelHeight : p.props.height as number}} />
                            </span>
                        </IfVisible>
                    </div>
