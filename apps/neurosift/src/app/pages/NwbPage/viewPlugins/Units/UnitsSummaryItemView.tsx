...
const adjustableParameters: { name: string; type: 'number'; choices: any[] }[] = [
  { name: 'correlogram_window_size_msec', type: 'number', choices: correlogramWindowSizeMsecChoices },
  { name: 'correlogram_bin_size_msec', type: 'number', choices: correlogramBinSizeMsecChoices },
];
