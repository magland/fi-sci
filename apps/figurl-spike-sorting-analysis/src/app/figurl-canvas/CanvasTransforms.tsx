...
export const nullTransformMatrix = matrix([
  [0, 0, 0],
  [0, 0, 0],
]);
  ...
  return useMemo(() => {
    ...
    if (preserveDataAspect === undefined || preserveDataAspect) {
      ...
      if (dataAspect > canvasAspect) {
        ...
        return {
          ...baseMargins,
          top: baseMargins.top + trimAmt,
          bottom: baseMargins.bottom + trimAmt,
        };
        ...
        return {
          ...baseMargins,
          left: baseMargins.left + trimAmt,
          right: baseMargins.right + trimAmt,
        };
      }
    }
    return baseMargins;
