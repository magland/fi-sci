  ...
  switch (action.type) {
    case 'report_total_time_range': {
      const newStartTimeSec =
        state.startTimeSec === undefined ? action.startTimeSec : Math.min(state.startTimeSec, action.startTimeSec);
      const newEndTimeSec =
        state.endTimeSec === undefined ? action.endTimeSec : Math.max(state.endTimeSec, action.endTimeSec);
      return {
        ...state,
    ...
    case 'set_current_time_fraction': {
      ...
      return {
        ...state,
        currentTimeSec:
          state.visibleStartTimeSec + action.fraction * (state.visibleEndTimeSec - state.visibleStartTimeSec),
      };
    }
    ...
    case 'pan_time_selection_pct': {
      ...
      let newVisibleStartTimeSec =
        state.visibleStartTimeSec + deltaPct * (state.visibleEndTimeSec - state.visibleStartTimeSec);
      let newVisibleEndTimeSec =
        state.visibleEndTimeSec + deltaPct * (state.visibleEndTimeSec - state.visibleStartTimeSec);
      if (newVisibleStartTimeSec < state.startTimeSec) {
        newVisibleStartTimeSec = state.startTimeSec;
        newVisibleEndTimeSec = newVisibleStartTimeSec + state.visibleEndTimeSec - state.visibleStartTimeSec;
      }
