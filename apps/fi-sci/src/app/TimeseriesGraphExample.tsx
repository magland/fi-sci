...
const TimeseriesGraphExample: FunctionComponent<Props> = ({ width }) => {
  return (
    <SetupTimeSelection>
      <p>
        The following two timeseries graphs are synchronized. Click and the use the mouse wheel to zoom. Hold mouse
        button and drag to pan.
      </p>
      <TimeseriesGraphView data={exampleData1} width={width} height={400} />
      <TimeseriesGraphView data={exampleData2} width={width} height={400} />
    </SetupTimeSelection>
  );
};
