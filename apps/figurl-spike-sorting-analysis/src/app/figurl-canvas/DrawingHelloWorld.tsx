...
import { Vec2, pointSpanToRegion, transformPoints } from './Geometry';
...
const DrawingHelloWorld = (props: DrawingHelloWorldProps) => {
  ...
  const frame = <CanvasFrame width={width} height={height} canvases={[canvas]} />;
...
export const DrawingHelloWorldClicks = (props: DrawingHelloWorldProps) => {
  ...
  const canvas = <BaseCanvas width={width} height={height} draw={drawPixelSpaceData} drawData={drawData} />;
...
export const DrawingHelloWorldDragRect = (props: DrawingHelloWorldProps) => {
  ...
  const dragCanvas = <DragCanvas width={width} height={height} newState={state.dragState} />;
  ...
  const frame = <CanvasFrame width={width} height={height} canvases={[canvas, dragCanvas]} handlers={handlers} />;
